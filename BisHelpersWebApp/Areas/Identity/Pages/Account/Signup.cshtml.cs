...
namespace BisHelpersWebApp.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            [Required]
            [StringLength(50,ErrorMessage ="please enter valid name")]
            [Display(Name = "Full Name")]
            public string StudentName { get; set; }

            [Required]
            [Display(Name = "Collage ID")]
            [Range(1000000, 9999999, ErrorMessage = "Please Make Sure That You Write Valid Your College")]
            //[StringLength(7, ErrorMessage = "Please Make Sure That You Write Valid Collage ID", MinimumLength = 7)]
            public int StudentCollageId { get; set; }

            [Required]
            [Range(2,4,ErrorMessage ="plese enter correct level")]
            [Display(Name = "Level")]
            public int Level { get; set; }

            [Required]
            [Range(0, 1, ErrorMessage = "plese enter correct Gender")]
            [Display(Name = "Gender")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.StudentCollageId = Input.StudentCollageId;
